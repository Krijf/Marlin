...
#define STRING_CONFIG_H_AUTHOR "(Krijf, Ender_3V2)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  21.13,  21.13 }
    #define DEFAULT_Ki_LIST {   1.95,   1.95 }
    #define DEFAULT_Kd_LIST {  57.17,  57.17 }
  #else
    // Ender 3 v2
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Ender 3 V2
  #define DEFAULT_bedKp 123.91
  #define DEFAULT_bedKi  20.89
  #define DEFAULT_bedKd 490.08
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 3, 24, 0 }
